package example.musicdemo2.zxing.activity;
...
import example.musicdemo2.util.BitmapUtil;
import example.musicdemo2.util.Constant;
import example.musicdemo2.zxing.camera.CameraManager;
import example.musicdemo2.zxing.decoding.CaptureActivityHandler;
import example.musicdemo2.zxing.decoding.InactivityTimer;
import example.musicdemo2.zxing.decoding.RGBLuminanceSource;
import example.musicdemo2.zxing.view.ViewfinderView;
